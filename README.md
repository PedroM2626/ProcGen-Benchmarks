...
- **Top cluster n=10 (item 3, rodando).** Re-rodando os 5 finalistas (`aug_noise`, `contrastive`, `impoola`, `mlp`, `spatial` × 3 jogos) com seeds 47–51 e eval-full em background; dobra o n do cluster top para 10 e testa se alguém se separa. Resultado entra aqui ao fechar.
